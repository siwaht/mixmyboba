            ...
            {related.map(p => (
              <div key={p.id} className="fbt-card">
                ...
                <button
                  ...
                  onClick={() => {
                    addItem({ productId: p.id, slug: p.slug, name: p.name, price: discountedPrice(p.price, 'onetime'), originalPrice: p.price, imageUrl: p.imageUrl, purchaseType: 'onetime' as const })
